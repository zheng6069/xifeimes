<template>
    <div class="MeasuringCheck_container">
        ...
        <div class="FRCContent_title">
            <div class="FRC_title">设备定检信息</div>
            <div class="FRC_info">
                <el-button
                    size="mini"
                    type="primary"
        ...
        <div :style="TableHeight">
            ...
            >
                ...
                <el-table-column prop="facilityType" label="设备类型" width="120"></el-table-column>
                <el-table-column prop="facilityNum" label="设备编号" width="120"></el-table-column>
                <el-table-column prop="repairDay" label="有效期至" width="100" :formatter="dateFormat"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        MeasuringCheckSearchList() {
            let that = this;
            let url = ResourceManagement.GET_K_Query;
            let data = {
            ...
            that.axios
                .post(url, data)
                .then(res => {
                    that.StandingMeasuringCheckArr = res.data.list;
        ...
        MeasuringCheckConfirm() {
            if (this.multipleSelection < 1) {
                ...
                let that = this;
                let url = ResourceManagement.GET_K_updateWorkCheckTime;
                let upadtaArryTime = [];

                
                that.multipleSelection.map(i => {
                      upadtaArryTime.push({
                        resourcesId : i.resourcesId,
                        facilityName : i.facilityName,
                        facilityNum :i.facilityNum,
                        planStartTime:i.planStartTime,
                        planEndTime:i.planEndTime,
                        mainStatus:i.mainStatus,
                    });
                    // upadtaArryTime.push(i.checkToolId);
                    // console.log(upadtaArryTime, "dsfs");
                });
        ...
        RegularInspectionCompleted(){
             if (this.multipleSelection < 1) {
                ...
                let that = this;
                let url = ResourceManagement.GET_K_RegularInspectionCompleted;
