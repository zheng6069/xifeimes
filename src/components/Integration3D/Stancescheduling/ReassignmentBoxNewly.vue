<template>
    <div>
        ...
        <div class="Rb_operation">
            <div class="Rb_operation_nei">
                <div class="RbOperationNei">
                    <p>工位</p>
                    <el-input
                ...
                <el-button
                    size="medium"
                    type="primary"
                    class="RbOperation_bnt"
                    @click="workOrder"
                >改派</el-button>
            </div>
        </div>
        <div class="Rb_contnet" :style="TableHeight">
            <div class="RbContent_title">
                <div class="Rb_title">备注：棕色-已派工，蓝色-已开工，紫色-已拆解，黄色-已暂停，绿色-已完工</div>
                <div class="Rb_info">
                    <el-button type="primary" size="mini" @click="returnRb">返回</el-button>
                </div>
            </div>
            <div class="Rb_contnet_table">
                <el-table
                    border
        ...
        <el-dialog
            class="renyuan"
            title="人员信息"
            :visible.sync="personnelDialogVisible33"
...
.RbContent_title .Rb_title {
    float: left;
    text-indent: 10px;
    font-size: 12px;
    line-height: 30px;
}
.RbContent_title .Rb_info {
    float: right;
    font-size: 12px;
    margin-right: 10px;
}
...
export default {
    ...
    created() {
        ...
        this.orderId = this.boxlist.orderId
        this.stationId = this.boxlist.stationId
        this.workFlowId = this.boxlist.workFlowId
    ...
    methods: {
        ...
        personnelSubmit(form) {
            if (this.personnelSelection < 1) {
                ...
                let url =
                    dispatchingManagement.GET_A_updatePerson +
                    "?workId=" +
                    this.orderId +
                    "&workNo=" +
                    this.instructWorkNo +
