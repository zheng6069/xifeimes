...
export default {
    data() {
        return {
            ...
            noShow: this.$route.query.noShow,
            one: "", // 质量记载单号
            two: "", // 工单号
            three: "", // 指令号
            four: "", // 指令名称
    ...
    methods: {
        gaodu() {
            ...
            this.TableHeight.height = window.innerHeight - 530 + "px";
        },
        AndWorkerBoxList() {
            this.axios({
                method: "get",
                url:
                    AssemblyPerform.GET_C_findByAIdInfo +
                    "?abnormalId=" +
                    this.abnormalId
            })
                .then(res => {
                    ...
                    this.three = resArray[0].instructionId;
