    ...
    <div>
        ...
        <div class="Dispatch_contnet" :style="TableHeight">
            <div class="Dispatch_title">
                ...
                <!-- <div class="DispatchBox_title">需完成指令：30 未完成指令：20</div> -->
            ...
            <div class="Dispatch_contnet_table">
                ...
                >
                    ...
                    <el-table-column prop="qty" label="承接人" width="80"></el-table-column>
                    <el-table-column
                        prop="startDate"
...
export default {
    ...
    methods: {
        gaodu() {
            ...
            this.TableHeight.height = window.innerHeight - 236 + "px";
        },
        //列表展示
        ONlist() {
            let that = this;
