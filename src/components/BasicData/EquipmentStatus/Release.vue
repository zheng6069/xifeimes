    ...
    <div class="Release_container">
        ...
        <div :style="TableHeight">
            ...
            >
                ...
                <el-table-column prop="maintainStatus" label="释放原因名称"></el-table-column>
        ...
        <el-dialog :visible.sync="ReleaseStatusVisible">
            <el-form :model="ReleaseStatusform" ref="ReleaseStatusform" class="ReleaseStatusform">
                <el-form-item label="释放原因名称" :label-width="formLabelWidth">
                    <el-input
                        v-model="ReleaseStatusform.one"
                        autocomplete="off"
                        placeholder="请输入释放原因名称"
                    ></el-input>
                </el-form-item>
            </el-form>
...
export default {
    data() {
        return {
            ...
            ReleaseStatusArr: [], // 释放原因状态
            ReleaseStatusSelection: [],
            ReleaseStatusVisible: false, // 释放原因弹框
            ReleaseStatusform: {
                one: "" // 释放原因状态名称
            }
        };
