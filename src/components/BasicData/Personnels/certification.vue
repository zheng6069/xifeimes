    ...
    <div class="Ex_container">
        ...
        <div :style="TableHeight">
            ...
            >
                ...
                <el-table-column prop="maintainStatus" label="资质维护"></el-table-column>
        ...
        <el-dialog :visible.sync="ExStatusVisible">
            <el-form :model="ExStatusform" ref="ExStatusform" class="ExStatusform">
                <el-form-item label="资质维护" :label-width="formLabelWidth">
                    <el-input v-model="ExStatusform.one" autocomplete="off" placeholder="请输入资质"></el-input>
                </el-form-item>
            </el-form>
