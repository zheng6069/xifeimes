...
export default {
    ...
    methods: {
        gaodu() {
            ...
            this.TableHeight.height = window.innerHeight - 480 + "px";
        },
        // 查询
        getSbSearchList() {
            let that = this;
        ...
        handleSelectionChange(val) {
            if (val.length > 1) {
                ...
                if (this.multipleSelection != undefined) {
                    this.infoList();
                    this.workRebutRemark = this.multipleSelection.workRebutRemark;
                }
            }
        },
        // 时间转换
