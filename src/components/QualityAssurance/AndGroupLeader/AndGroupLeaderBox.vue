<template>
    <div>
        ...
        <div class="And_DescriptionProcessing">
            ...
            <div class="And_HandlingOpinions">
                <p>处理意见</p>
                <div>
        ...
        <div class="And_fooer">
            <div class="And_ProcessingResults">
                <p>处理结果</p>
                <div>
                    <el-select
                        size="medium"
        ...
        OnQuery() {
            this.axios
                ...
                .then(res => {
                    ...
                    this.FaultDescription = res.data.description; //故障描述
                    this.HandlingOpinions = res.data.groupAdvice; //处理意见
            ...
            if (this.HandlingOpinions != "") {
                this.axios({
                    ...
                    data: {
                        ...
                        groupAdvice: this.HandlingOpinions, //处理意见
...
.And_HandlingOpinions {
    width: 49.5%;
    height: 100%;
    float: right;
    overflow: hidden;
}
.And_HandlingOpinions p {
    width: 80px;
    height: 100%;
    float: left;
}
.And_HandlingOpinions div {
    width: calc(100% - 80px);
    width: -moz-calc(100% - 80px);
    width: -webkit-calc(100% - 80px);
    width: -o-calc(100% - 80px);
...
.And_ProcessingResults {
    width: 280px;
    overflow: hidden;
}
.And_ProcessingResults p {
    width: 80px;
    float: left;
    margin: 0px;
    line-height: 40px;
}
.And_ProcessingResults div {
    width: 200px;
    float: left;
}
.And_btn {
