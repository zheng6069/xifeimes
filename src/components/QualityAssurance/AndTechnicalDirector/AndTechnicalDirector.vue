    ...
    <div>
        ...
        <div class="Dispatch_title">
            ...
            <div class="DispatchBox_info">
                <el-button @click="OnSee" type="primary" size="mini">指定处理人</el-button>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        OnQuery() {
            this.axios({
                method: "post",
                url: AssemblyPerform.GET_C_Query + "?abStatus=" + 2,
                data: {
        ...
        Tick(row) {
            if (row.length > 1) {
                ...
                if (this.DeleteArr != undefined) {
                    this.abnormalId = this.DeleteArr.abnormalId;
                } else {
                    this.abnormalId = "";
                }
            }
        ...
        // 查看
        OnSee() {
            if (this.abnormalId != "" && this.abnormalId != undefined) {
                this.$router.push({
