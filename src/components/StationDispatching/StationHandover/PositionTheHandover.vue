        ...
        <div class="For_LargeBox">
            <div class="For_LargeLeft">
                ...
                <div class="For_LargeLeftencer">
                    <StationHandoverNewly v-if="Finalassembly == 1" ref="mychild"></StationHandoverNewly>
                    <AbnormalqualityNewly v-if="Finalassembly == 2" ref="mychild"></AbnormalqualityNewly>
                </div>
            </div>
            <div class="For_LargeRight">
                <div class="For_LargeLeftitle"><p>总装3站位概况</p></div>
                <iframe class="For_LargeRight_iframe" src="https://www.baidu.com"></iframe>
            </div>
        </div>
    </div>
</template>
...
import StationHandoverNewly from '../../Integration3D/Stancescheduling/StationHandoverNewly';
import AbnormalqualityNewly from '../../AssemblyExecution/Workers/AbnormalqualityNewly';
export default {
  components: { StationHandoverNewly,AbnormalqualityNewly },
    data() {
        return {
            Finalassembly: 1,
            TableHeight: {
